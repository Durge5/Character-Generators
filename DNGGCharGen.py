...
# Starter Religions as based on Wintersun Skyrim:
'''
NordDivines = ['Random', 'Akatosh', 'Arkay', 'Dibella',
               'Kynareth', 'Mara', 'Stendarr', 'Talos', 'Zenithar', 'Shor']
BretonDivines = ['Random', 'Akatosh', 'Arkay', 'Dibella', 'Mara',
                 'Stendarr', 'Zenithar', 'Magnus', 'Phynaster', 'Xarxes']
ImperialDivines = ['Random', 'Akatosh', 'Arkay', 'Dibella',
                   'Julianos', 'Kynareth', 'Mara', 'Stendarr', 'Talos', 'Zenithar']
KhajiitDivines = ['Random', 'Akatosh', 'Kynareth', 'Azura',
                  'Mehrunes Dagon', 'Mephala', 'Sheogorath', 'Rajhin', 'Riddle\'Thar']
WoodElfDivines = ['Random', 'Arkay', 'Mara', 'Stendarr', 'Hircine',
                  'Auriel', 'Jephre', 'Magnus', 'Phynaster', 'Xarxes', 'Z\'en', 'Baan Dar']
HighElfDivines = ['Random', 'Stendarr', 'Auriel',
                  'Jephre', 'Magnus', 'Phynaster', 'Syrabane', 'Xarxes']
DarkElfDivines = ['Random', 'Azura', 'Boethiah', 'Malacath',
                  'Mehrunes Dagon', 'Mephala', 'Molag Bal', 'Sheogorath']
RedguardDivines = ['Random', 'Leki', 'Morwha',
                   'Satakal', 'Tall Papa', 'The HoonDing']
ArgonianDivines = ['Random', 'Sithis', 'The Hist']
OrcDivines = ['Random', 'Malacath', 'Trinimac']

divinesByRaceList = [ArgonianDivines, BretonDivines, DarkElfDivines, HighElfDivines,
                     ImperialDivines, KhajiitDivines, NordDivines, RedguardDivines, OrcDivines, WoodElfDivines]
'''
